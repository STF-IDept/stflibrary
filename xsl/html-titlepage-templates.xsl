...
<xsl:template name="set.titlepage.recto">
  ...
  <xsl:apply-templates mode="set.titlepage.recto.auto.mode" select="setinfo/editor"/>
  <xsl:apply-templates mode="set.titlepage.recto.auto.mode" select="info/editor"/>
...
<xsl:template match="editor" mode="set.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="set.titlepage.recto.style">
<xsl:apply-templates select="." mode="set.titlepage.recto.mode"/>
</div>
</xsl:template>
